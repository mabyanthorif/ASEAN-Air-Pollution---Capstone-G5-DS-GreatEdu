...
cluster_colors = {0: 'red', 1: 'blue', 2: 'orange'}
cluster_descriptions = {0: 'Kualitas udara sangat buruk', 1: 'Kualitas udara sehat', 2: 'Kualitas udara buruk'}
cluster_warnings = {
    0: "Kualitas udara sangat buruk. Tidak sehat bagi kelompok sensitif. ☠️",
    2: "Kualitas udara buruk. Demi kesehatan Anda, mohon berhati-hati saat berada di luar rumah dan gunakan masker jika perlu.😷"
}
